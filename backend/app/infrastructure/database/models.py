...
from sqlalchemy import String, Integer, Numeric, Boolean, DateTime, JSON, Enum as SAEnum, ForeignKey, Float, text, Index
from sqlalchemy.orm import DeclarativeBase, Mapped, mapped_column, relationship
from sqlalchemy.sql import func
from app.domain.value_objects.enums import (
    StationType, TrainType, TravelClass, BusOperator, BusType,
    SeatStatus, TransferType, TravelMode, TransportType,
    TransferDifficulty, LightingQuality, CrowdLevel, DatasetStatus
)
...
class NearbyConnection(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    station_id: Mapped[str | None] = mapped_column(String, ForeignKey("stations.id"), nullable=True)
    bus_stop_id: Mapped[str | None] = mapped_column(String, ForeignKey("bus_stops.id"), nullable=True)
    connected_station_id: Mapped[str | None] = mapped_column(String, ForeignKey("stations.id"), nullable=True)
    connected_bus_stop_id: Mapped[str | None] = mapped_column(String, ForeignKey("bus_stops.id"), nullable=True)
