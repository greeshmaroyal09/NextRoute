...
from app.infrastructure.database.models import (
    Base, Station, TrainRoute, TrainStop, TrainFare,
    BusStop, BusRoute, BusStopSequence, NearbyConnection,
    ScoringWeight, SystemSetting
)
...
stations_data = [
    ...
    ("MAS", "Chennai Central", "Chennai", "TN", 13.0827, 80.2707, "MAJOR_JUNCTION", "SR"),
    ("MS", "Chennai Egmore", "Chennai", "TN", 13.0732, 80.2609, "JUNCTION", "SR"),
    ("SBC", "KSR Bengaluru", "Bengaluru", "KA", 12.9716, 77.5946, "MAJOR_JUNCTION", "SWR"),
    ("YPR", "Yesvantpur", "Bengaluru", "KA", 13.0358, 77.5500, "JUNCTION", "SWR"),
    ("MDU", "Madurai Junction", "Madurai", "TN", 9.9195, 78.1193, "MAJOR_JUNCTION", "SR"),
    ("CBE", "Coimbatore Junction", "Coimbatore", "TN", 11.0168, 76.9558, "MAJOR_JUNCTION", "SR"),
    ("SA", "Salem Junction", "Salem", "TN", 11.6643, 78.1460, "JUNCTION", "SR"),
    ("ED", "Erode Junction", "Erode", "TN", 11.3410, 77.7172, "JUNCTION", "SR"),
    ("TPJ", "Tiruchirappalli Junction", "Tiruchirappalli", "TN", 10.7905, 78.6826, "MAJOR_JUNCTION", "SR"),
    ("TEN", "Tirunelveli Junction", "Tirunelveli", "TN", 8.7254, 77.6939, "JUNCTION", "SR"),
    ("TCN", "Tuticorin", "Tuticorin", "TN", 8.7642, 78.1348, "REGULAR", "SR"),
    ("VM", "Villupuram Junction", "Villupuram", "TN", 11.9394, 79.4925, "JUNCTION", "SR"),
    ("KPD", "Katpadi Junction", "Katpadi", "TN", 12.9672, 79.1453, "JUNCTION", "SR"),
    ("JTJ", "Jolarpettai", "Jolarpettai", "TN", 12.5680, 78.5730, "JUNCTION", "SR"),
    ("AJJ", "Arakkonam Junction", "Arakkonam", "TN", 13.0716, 79.6724, "JUNCTION", "SR"),
    ("KRR", "Karur Junction", "Karur", "TN", 10.9601, 78.0766, "REGULAR", "SR"),
    ("DG", "Dindigul Junction", "Dindigul", "TN", 10.3624, 77.9695, "JUNCTION", "SR"),
    ("VPT", "Virudhunagar Junction", "Virudhunagar", "TN", 9.5858, 77.9518, "JUNCTION", "SR"),
    ("SC", "Secunderabad Junction", "Hyderabad", "TS", 17.4344, 78.5013, "MAJOR_JUNCTION", "SCR"),
    ...
    ("RU", "Renigunta Junction", "Renigunta", "AP", 13.6515, 79.5156, "JUNCTION", "SCR"),
    ("BZA", "Vijayawada Junction", "Vijayawada", "AP", 16.5193, 80.6305, "MAJOR_JUNCTION", "SCR"),
    ("VSKP", "Visakhapatnam", "Visakhapatnam", "AP", 17.7215, 83.3025, "MAJOR_JUNCTION", "SCR"),
    ...
    ("GTL", "Guntakal Junction", "Guntakal", "AP", 15.1711, 77.3752, "MAJOR_JUNCTION", "SCR"),
    ("ATP", "Anantapur", "Anantapur", "AP", 14.6819, 77.5006, "REGULAR", "SCR"),
    ("DMM", "Dharmavaram Junction", "Dharmavaram", "AP", 14.4136, 77.7111, "JUNCTION", "SCR"),
    ...
    ("ERS", "Ernakulam Junction", "Kochi", "KL", 9.9816, 76.2999, "MAJOR_JUNCTION", "SR"),
    ("TVC", "Thiruvananthapuram Central", "Thiruvananthapuram", "KL", 8.4855, 76.9492, "MAJOR_JUNCTION", "SR"),
...
train_routes_data = [
    ("12637", "Pandian Express", "EXPRESS", "daily", [("MAS", "21:30", "21:30", 0), ("VM", "23:15", "23:20", 0), ("TPJ", "01:40", "01:45", 1), ("DG", "03:50", "03:55", 1), ("MDU", "05:15", "05:15", 1)]),
    ("12657", "Chennai Mail", "SUPERFAST", "daily", [("SBC", "23:00", "23:00", 0), ("KPD", "01:30", "01:35", 1), ("AJJ", "03:00", "03:05", 1), ("MAS", "04:30", "04:30", 1)]),
    ("12609", "Chennai Express", "EXPRESS", "daily", [("SBC", "06:00", "06:00", 0), ("JTJ", "08:00", "08:05", 0), ("KPD", "09:00", "09:05", 0), ("AJJ", "10:15", "10:20", 0), ("MAS", "11:30", "11:30", 0)]),
    ("16525", "Island Express", "EXPRESS", "daily", [("SBC", "15:15", "15:15", 0), ("SA", "19:00", "19:05", 0), ("ED", "19:45", "19:50", 0), ("CBE", "21:15", "21:20", 0), ("ERS", "02:15", "02:20", 1), ("TVC", "06:15", "06:15", 1)]),
    ("17603", "Kacheguda Express", "EXPRESS", "daily", [("SC", "18:30", "18:30", 0), ("GTL", "01:30", "01:35", 1), ("DMM", "03:00", "03:05", 1), ("SBC", "06:30", "06:30", 1)]),
    ("12785", "Bangalore Express", "SUPERFAST", "daily", [("SC", "22:30", "22:30", 0), ("GY", "03:00", "03:05", 1), ("GTL", "04:00", "04:05", 1), ("SBC", "07:00", "07:00", 1)]),
    ("12615", "Grand Trunk Express", "SUPERFAST", "daily", [("MAS", "19:20", "19:20", 0), ("AJJ", "20:45", "20:50", 0), ("RU", "22:45", "22:50", 0), ("GDR", "23:30", "23:35", 0), ("OGL", "01:30", "01:35", 1), ("BZA", "04:30", "04:40", 1), ("SC", "11:00", "11:00", 1)]),
    ("12627", "Karnataka Express", "SUPERFAST", "daily", [("MAS", "06:00", "06:00", 0), ("AJJ", "07:15", "07:20", 0), ("KPD", "08:45", "08:50", 0), ("JTJ", "10:00", "10:05", 0), ("SBC", "12:00", "12:00", 0)]),
    ("16353", "Nagercoil Express", "EXPRESS", "daily", [("MAS", "17:00", "17:00", 0), ("VM", "19:30", "19:35", 0), ("TPJ", "22:00", "22:05", 0), ("DG", "00:30", "00:35", 1), ("MDU", "01:45", "01:50", 1), ("VPT", "03:00", "03:05", 1), ("TEN", "05:15", "05:15", 1)]),
    ("11013", "Coimbatore Express", "EXPRESS", "daily", [("MAS", "22:20", "22:20", 0), ("AJJ", "23:45", "23:50", 0), ("SA", "02:30", "02:35", 1), ("ED", "03:15", "03:20", 1), ("CBE", "05:00", "05:00", 1)]),
    ("16339", "Nagarcoil Express", "EXPRESS", "daily", [("MAS", "21:00", "21:00", 0), ("VM", "23:00", "23:05", 0), ("TPJ", "01:30", "01:35", 1), ("CBE", "06:00", "06:05", 1), ("ERS", "09:30", "09:30", 1)]),
    ("12629", "Yercaud Express", "EXPRESS", "daily", [("MAS", "23:00", "23:00", 0), ("KPD", "01:00", "01:05", 1), ("JTJ", "02:30", "02:35", 1), ("SA", "04:00", "04:00", 1)]),
    ("17229", "Sabari Express", "EXPRESS", "1010100", [("SC", "07:30", "07:30", 0), ("GTL", "14:00", "14:10", 0), ("SBC", "21:00", "21:15", 0), ("ERS", "06:00", "06:05", 1), ("TVC", "10:30", "10:30", 1)]),
    ("12863", "Howrah Express", "SUPERFAST", "daily", [("MAS", "22:50", "22:50", 0), ("GDR", "02:00", "02:05", 1), ("OGL", "04:30", "04:35", 1), ("BZA", "07:00", "07:10", 1), ("VSKP", "13:30", "13:30", 1)]),
    ("56213", "Passenger", "PASSENGER", "daily", [("MDU", "06:00", "06:00", 0), ("DG", "07:15", "07:20", 0), ("KRR", "08:30", "08:35", 0), ("TPJ", "10:00", "10:00", 0)]),
]
...
bus_stops_data = [
    ...
    ("TPJ-BS", "Trichy Central Bus Stand", "Tiruchirappalli", "TN", 10.8005, 78.6895, "TNSTC"),
    ...
    ("VSKP-BS", "Visakhapatnam Bus Complex", "Visakhapatnam", "AP", 17.7100, 83.3000, "APSRTC"),
    ...
    ("TVC-BS", "Trivandrum KSRTC", "Thiruvananthapuram", "KL", 8.4880, 76.9500, "KSRTC"),
...
bus_routes_data = [
    ("KSRTC-1", "KSRTC", "SUPER_LUXURY", 30, [("SBC-MJSTC", "00:00", "00:00", 0.0), ("MYS-BS", "03:00", "03:00", 400.0)]),
    ("TNSTC-1", "TNSTC", "EXPRESS", 60, [("MAS-CMBT", "00:00", "00:00", 0.0), ("TPJ-BS", "05:00", "05:15", 300.0), ("MDU-BS", "08:00", "08:00", 450.0)]),
    ("APSRTC-1", "APSRTC", "SUPER_LUXURY", 45, [("SC-MGBS", "00:00", "00:00", 0.0), ("BZA-BS", "05:00", "05:00", 600.0)]),
    ("TSRTC-1", "TSRTC", "EXPRESS", 30, [("SC-MGBS", "00:00", "00:00", 0.0), ("WL-BS", "03:00", "03:00", 250.0)]),
    ("KSRTC-2", "KSRTC", "SLEEPER", 120, [("SBC-MJSTC", "00:00", "00:00", 0.0), ("MAQ-BS", "08:00", "08:00", 800.0)]),
    ("TNSTC-2", "TNSTC", "SUPER_LUXURY", 90, [("CBE-BS", "00:00", "00:00", 0.0), ("SA-BS", "03:00", "03:15", 250.0), ("MAS-CMBT", "10:00", "10:00", 700.0)]),
    ("APSRTC-2", "APSRTC", "SLEEPER", 120, [("SC-MGBS", "00:00", "00:00", 0.0), ("TPTY-BS", "12:00", "12:00", 850.0)]),
    ("KSRTC-3", "KSRTC", "EXPRESS", 60, [("SBC-MJSTC", "00:00", "00:00", 0.0), ("UBL-BS", "07:00", "07:00", 550.0)]),
    ("APSRTC-3", "APSRTC", "EXPRESS", 60, [("BZA-BS", "00:00", "00:00", 0.0), ("VSKP-BS", "06:00", "06:00", 500.0)]),
    ("APSRTC-4", "APSRTC", "EXPRESS", 90, [("ATP-BS", "00:00", "00:00", 0.0), ("SBC-MJSTC", "05:00", "05:00", 400.0)]),
    ("KSRTC-4", "KSRTC", "SUPER_LUXURY", 45, [("TVC-BS", "00:00", "00:00", 0.0), ("ERS-BS", "05:00", "05:00", 350.0)]),
    ("TNSTC-3", "TNSTC", "ORDINARY", 120, [("SA-BS", "00:00", "00:00", 0.0), ("SBC-MJSTC", "05:00", "05:00", 300.0)]),
]
...
settings_data = [
    ...
    ("min_transfer_buffer_mins", "20", "INTEGER", "graph", "Minimum buffer between connections"),
    ...
    ("graph_rebuild_cron", '"0 3 * * 0"', "STRING", "graph", "Weekly graph rebuild schedule"),
        ...
        for tr_num, tr_name, tr_type, runs_on, stops in train_routes_data:
            ...
            for i in range(len(stop_objects)):
                for j in range(i+1, len(stop_objects)):
                    ...
                    for t_class, rate in [("GENERAL", 0.5), ("SLEEPER", 1.0), ("AC_3", 2.0), ("AC_2", 3.0)]:
                        fare = TrainFare(
                            train_route_id=route.id,
