from app.domain.entities.journey import (
    ExplainedJourney,
    ExplainReason,
    ScoredJourney,
    TransferDifficultyResult,
)
...
class ExplainabilityEngine:
    def explain(
        ...
        transfer_results: list[TransferDifficultyResult],
    ) -> ExplainedJourney:
        positive_reasons = []
        negative_reasons = []
        badges = []
        ...
        # Transfer logic
        if any(
            tr.difficulty == TransferDifficulty.DIFFICULT for tr in transfer_results
        ):
            negative_reasons.append(
                ExplainReason(
                    icon="🏃",
            ...
            all(tr.difficulty == TransferDifficulty.EASY for tr in transfer_results)
            and transfer_results
        ):
            positive_reasons.append(
                ExplainReason(
                    icon="✅",
