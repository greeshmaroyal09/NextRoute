...
FLUTTER_TEST = '''import 'package:flutter/material.dart';
...
def write_flutter_test():
    os.makedirs('frontend/test', exist_ok=True)
    with open('frontend/test/search_screen_test.dart', 'w', encoding='utf-8') as f:
        f.write(FLUTTER_TEST)
    print("Flutter test generated.")
